...
#define PORT            "80"
#define API_WRITE_KEY   "XVC25I1ENU6KDP1B"
#define CHANNEL_ID      "1344048"

#define SSID            "Astro"
#define PASSWORD        "astro6hee"
...
void loop() {
    ...
    sprintf(_buffer, "GET https://api.thingspeak.com/update?api_key=XVC25I1ENU6KDP1B&field1=77", API_WRITE_KEY, Sample++);  /*connect to thingspeak server to post data using your API_WRITE_KEY*/
